...
class LoginApiResponseModel {
  ...
  factory LoginApiResponseModel.fromMap(Map<String, dynamic> map) {
    return LoginApiResponseModel(
      ...
      data: map['data'] != null ? LoginApiResponseDataModel.fromMap(map['data'] as Map<String, dynamic>) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory LoginApiResponseModel.fromJson(String source) => LoginApiResponseModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'LoginApiResponseModel(status: $status, message: $message, data: $data)';
}
...
class LoginApiResponseDataModel {
  ...
  factory LoginApiResponseDataModel.fromJson(String source) => LoginApiResponseDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
