...
class VerifyOtpApiResponseData {
  ...
  factory VerifyOtpApiResponseData.fromJson(String source) => VerifyOtpApiResponseData.fromMap(json.decode(source) as Map<String, dynamic>);
...
class VerifyOtpApiResponse {
  ...
  factory VerifyOtpApiResponse.fromMap(Map<String, dynamic> map) {
    return VerifyOtpApiResponse(
      ...
      data: map['data'] != null ? VerifyOtpApiResponseData.fromMap(map['data'] as Map<String, dynamic>) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory VerifyOtpApiResponse.fromJson(String source) => VerifyOtpApiResponse.fromMap(json.decode(source) as Map<String, dynamic>);
}
