...
class GetPatientListApiResponse {
  ...
  factory GetPatientListApiResponse.fromJson(String source) => GetPatientListApiResponse.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'GetPatientListApiResponse(status: $status, message: $message, data: $data)';
...
class MyPatient {
  ...
  factory MyPatient.fromJson(String source) => MyPatient.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  int get hashCode {
    return id.hashCode ^ name.hashCode ^ gender.hashCode ^ weight.hashCode ^ relation.hashCode ^ dateOfBirth.hashCode ^ photo.hashCode;
  }
}
