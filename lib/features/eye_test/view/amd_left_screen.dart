...
import 'package:eye_buddy/features/eye_test/view/amd_right_instruction_screen.dart';
...
class AmdLeftScreen extends StatelessWidget {
  const AmdLeftScreen({super.key});
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: CustomButton(
                        title: 'Yes',
                        callBackFunction: () {
                          // In BLoC: Yes means abnormal (no score increment)
                          Get.to(() => const AmdRightInstructionScreen());
                        },
                      ),
                    ),
                  ),
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: CustomButton(
                        ...
                        callBackFunction: () {
                          // In BLoC: No increments by +5 (normal indicator)
                          controller.incrementAmdLeft();
                          Get.to(() => const AmdRightInstructionScreen());
                        },
                      ),
                    ),
