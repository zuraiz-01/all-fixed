...
import 'package:eye_buddy/features/eye_test/view/near_vision_right_instruction_screen.dart';
...
class NearVisionLeftScreen extends StatelessWidget {
  const NearVisionLeftScreen({super.key});
